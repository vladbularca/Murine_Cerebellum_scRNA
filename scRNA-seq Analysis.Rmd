...
cluster_ids <- c(
  "0" = "Midbrain Glutamatergic Cells", "1" = " GNP Transitionary Cells", "2" = "Migrating GNPs", "3" = "Bergmann Glia", "4" = "Cycling Progenitors",
...
write.csv(cluster_df, "custom_clusters.csv", row.names = FALSE)
